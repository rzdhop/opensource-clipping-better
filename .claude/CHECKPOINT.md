...
- **Phase:** IMPLEMENT. Group 1 merged and pushed (`7d374b2`). Group 2 merged and pushed (`b6202c9`). Next stage: S15 (B1b, web cancel wiring + ffmpeg child kill -- HIGH RISK) on feature/job-lifecycle.
