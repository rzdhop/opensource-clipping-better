...
| `--nvidia-model` | `nvidia/nemotron-3.5-lightning-30b-a3b` | Model for NVIDIA NIM API. `https://integrate.api.nvidia.com/v1/models` lists more than an account can actually call; verify with `tools/bench_llm.py` |
