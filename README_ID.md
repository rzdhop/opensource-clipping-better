...
| `--nvidia-model` | `nvidia/nemotron-3-super-120b-a12b` | Model untuk NVIDIA NIM. Model kadang dipensiunkan; lihat daftar terkini di `https://integrate.api.nvidia.com/v1/models`. |
